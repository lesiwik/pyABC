...
class ABCSMC:
    ...
    def run(self,
            ...
            max_computation_time: int = 1000000,
        ...
        # begin of the computations
        computation_start_time = datetime.datetime.now()
        ...
        while t <= t_max:
           ...
           # end time of specific iteration
            ...
            if current_eps <= minimum_epsilon:
                ...
                break
            elif (iteration_end_time - computation_start_time).total_seconds() > max_computation_time:
                logger.info("Stopping: Max Time elapsed.")
                break
